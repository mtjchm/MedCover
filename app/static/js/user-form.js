/* Phone and password field validation — used on user detail and profile pages. */
(function () {
  ...
  var phoneInput = attach('edit_phone', validatePhone) || attach('phone', validatePhone);
  var pwInput    = attach('new_password', validatePassword);

  // Attach to any form that has a save action
